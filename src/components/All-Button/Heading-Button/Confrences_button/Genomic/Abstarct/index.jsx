...
function GenomicAbstractTemplate() {
  return (
    <div>
      ...
      <div className="new-abst-template-hero-container">
        <div className="new-abst-template-overlay">
          <div className="new-abst-template-text-container">
            <h1 className="new-abst-template-heading">
              Pediatric Genomics Abstract Submission Form
            </h1>
            <p className="new-abst-template-SubHeading">
              Feel free to let me know if there’s anything else you need help
              with!
            </p>
            <p className="new-abst-template-sub-heading">Abstract Template</p>
            <a
              href="/Sample_Abstract_Template.docx"
              download
              className="new-abst-template-download-button"
            >
              Download Here
            </a>
          </div>
      ...
      <div className="new-abst-template-main-content">
        <div className="new-abst-template-form-container">
          <form className="new-abst-template-form">
            <label className="new-abst-template-label">
              Full Name
              <input
                type="text"
                name="fullName"
                className="new-abst-template-input"
                required
              />
            </label>
            <label className="new-abst-template-label">
            ...
            <label className="new-abst-template-label">
              ...
              <select
                ...
                className="new-abst-template-select"
                required
              >
            ...
            <button type="submit" className="new-abst-template-button">
              Submit
            </button>
          </form>
        </div>

        <div className="new-abst-template-forum-section">
          <h2 className="new-abst-template-forum-heading">
            <u>Abstract Forums</u>
          </h2>
          <div className="new-abst-template-forum-container">
            {forums.map((forum, index) => (
              <div key={index} className="new-abst-template-forum-card">
                <div className="new-abst-template-icon">{forum.icon}</div>
                <div className="new-abst-template-forum-name">{forum.name}</div>
              </div>
            ))}
          </div>
          <a href="#" className="new-abst-template-publications-link">
...
export default GenomicAbstractTemplate;
